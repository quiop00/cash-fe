...
export const DashboardMenu = [
	...
	{ id: uuid(), link: '/pages/users/list', title: 'User', icon: 'user' },
	...
	{ id: uuid(), link: '/pages/settings', title: 'Notifications', icon: 'notification' },
	...
	// { id: uuid(), link: '/pages/pricing', title: 'Pricing' },
	// { id: uuid(), link: '/404', title: '404 Error' },
	// {
	// 	id: uuid(),
	// 	title: 'LAYOUTS & PAGES',
	// 	grouptitle: true
